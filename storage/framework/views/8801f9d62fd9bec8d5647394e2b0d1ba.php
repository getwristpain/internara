        ...
        <div class="flex flex-col gap-4 md:max-w-sm md:wh-full md:justify-between lg:max-w-full">
            <div class="space-y-2">
                ...
                <h1 class="flex text-heading-xl">
                    Selamat Datang <br> di <?php echo e(config('app.name', 'Internara')); ?>
            ...
            <div
                ...
                <span class="text-sm font-medium text-gray-600"><?php echo e('Version ' . config('app.version', '1.0')); ?></span>
            </div>
        </div>
    </div>
</div><?php /**PATH /home/reasnovynt/Projects/apps/getwristpain/internara/resources/views/livewire/pages/installations/welcome.blade.php ENDPATH**/ ?>