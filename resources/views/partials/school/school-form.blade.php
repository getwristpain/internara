...
<x-form class="p-6" name="schoolForm" :$submit :$title :$desc :$shadowed :$bordered>
    <div class="flex flex-col">
        <x-input type="image" field="form.data.logo_file" label="Logo Sekolah" placeholder="Unggah Logo" aspect="square"
            required preview="{{ $logo_preview }}" />

        <div class="flex flex-col md:flex-row gap-x-4">
            <x-input type="bussiness" field="form.data.name" label="Nama Sekolah" placeholder="Masukkan nama sekolah..."
                required />
        ...
        <div class="flex flex-col md:flex-row gap-x-4">
            <x-input type="tel" field="form.data.telp" label="Telp. Sekolah" placeholder="(xxx) xxxx-xxxx"
                required />
            <x-input type="tel" field="form.data.fax" label="Fax. Sekolah" placeholder="(xxx) xxxx-xxxx" required />
        </div>
