...
<div class="w-full space-y-2 {{ $disabled ? 'disabled' : '' }}">
    ...
    <div class="space-y-4">
        ...
        <div class="items-center layout-cols">
            <x-forms.input-select wire:key="{{ \App\Helpers\Helper::key('input_select_subdistrict') }}"
            ...
            <div class="flex w-full gap-4">
                <div class="flex-1">
                    <x-forms.input-text wire:key="{{ \App\Helpers\Helper::key('input_text_street') }}" type="text"
                        name="{{ $name . '_street' }}" model="{{ $model . '.street' }}"
                        placeholder="RT/RW/Nama Jalan/Nomor Bangunan (Opsional)" />
                </div>
                <div class="w-1/3">
                    <x-forms.input-text wire:key="{{ \App\Helpers\Helper::key('input_text_postal_code') }}"
