    ...
    <div class="space-y-4">
        ...
        <div class="items-center layout-cols">
            ...
            <div class="flex items-center w-full gap-4">
                <x-input-text class="w-full" wire:key="{{ \App\Helpers\Helper::key('input_text_street') }}"
                    type="text" name="{{ $name . '_street' }}" model="{{ $model . '.street' }}"
                    placeholder="RT/RW/Nama Jalan/Nomor Bangunan (Opsional)" />

                <x-input-text class="max-w-40" wire:key="{{ \App\Helpers\Helper::key('input_text_postal_code') }}"
