...
describe('Translator', function () {
    test('translates a plain string message as-is', function () {
    ...
    test('translates a message using a translation key', function () {
        $expected = __('tests.message', [], 'en');
        $result = Translator::translate('tests.message', [], 'en');
        expect($result)->toBe($expected);
    });

    test('translates a message with resource replacement using translation key', function () {
    ...
    test('translates a message with resource replacement using custom locale', function () {
